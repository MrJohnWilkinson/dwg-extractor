...
class TestExtractionIssuesSheet:
    ...
    def test_extraction_issues_sheet_position(
        ...
        """Test that Extraction Issues sheet is at position 9 (index 8)."""
        from core.constants import EXCEL_SHEET_EXTRACTION_ISSUES
        ...
        # Extraction Issues should be at index 8 (Sheet 9, after Instructions was added)
        assert EXCEL_SHEET_EXTRACTION_ISSUES in wb.sheetnames
        assert wb.sheetnames.index(EXCEL_SHEET_EXTRACTION_ISSUES) == 8
