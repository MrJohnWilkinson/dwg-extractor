...
class TestExcelWriter:
    ...
    def test_write_excel_basic(self, temp_dir, sample_block_data):
    ...
    def test_excel_has_headers(self, temp_dir, sample_block_data):
    ...
    def test_excel_sorted_descending(self, temp_dir):
    ...
    def test_excel_autofilter(self, temp_dir, sample_block_data):
    ...
    def test_filename_format(self, temp_dir, sample_block_data):
    ...
    def test_column_widths(self, temp_dir, sample_block_data):
    ...
    def test_none_data_raises_error(self, temp_dir):
        """Test that None data raises ValueError."""
        output_path = os.path.join(temp_dir, 'test_drawing.dwg')

        with pytest.raises(ValueError, match="block_data cannot be None"):
            write_excel(None, output_path)

    def test_multiple_blocks(self, temp_dir):
