...
**Branch:** `dwg-extractor-stage`

**Implementation Progress:**
-  Phase 1: Project setup (uv, dependencies, structure, logging)
-  Phase 2: Core logic (extraction, Excel writing, tests)
- [ ] Phase 3: GUI implementation (pending)
- [ ] Phase 4: Testing and validation (pending)
- [ ] Phase 5: Build scripts and packaging (pending)

**Modified Files (Uncommitted):**
- `app/core/constants.py`, `extractor.py`, `excel_writer.py`
- `app/tests/core/test_extractor.py`, `test_excel_writer.py`
- `app/tests/assets/` (3 test DXF files)
